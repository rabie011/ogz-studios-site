...
(() => {
  ...
  const WORKS = [
    ...
    { client:{en:"Karim Osama × Sulisizer",ar:"كريم أسامة وسولي"}, title:{en:"3alabyad · ع الأبيض",ar:"ع الأبيض"}, disc:{en:"Official Music Video",ar:"فيديو كليب رسمي"}, year:"2024", col:1, ar:"4/5", bg:"linear-gradient(150deg,#3349EB 0%,#1a0a2e 70%,#000 100%)", watch:"https://www.youtube.com/watch?v=n15ZXzXOY_I", embed:"https://www.youtube.com/embed/n15ZXzXOY_I?autoplay=1" },
